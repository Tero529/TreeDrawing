 ...
 * the Wetherell Shannon Tree Placement Algorith before using the generated x and y values
...
#include "WetherellShannon.h" // Tree Drawing Algorithm which sets x and y positions with node structure
#include "drawFunctionsWS.h" // All Functions related to rendering to screen using OpenGL
...
int main(int argc,char **argv){
    ...
    /* then sets the AlgorithmType according to what is needed*/
    enum AlgorithmType secondPass=MODIFIED;


    /*! It then runs Tree Drawing Algorithm in "WetherellShannon.h" using the root of the
    tree generated, the height of the tree and the type of second pass required */
